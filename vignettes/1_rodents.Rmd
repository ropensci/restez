...
Setting up the rodents database will likely take a long time. The exact time will depend on your internet speeds and machine specs. For reference, this vigenette was written on an iMac (2019) with a download speed of 56 MBPS. With this setup, downloading the database took 1.9 hr and creating the database took 5.3 hr.
...
# download for domain 10 (rodents as of GenBank release 252)
...
#> ... GenBank Release 252
#> ... Last updated '2022-11-08 14:13:56'
#> ───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
#> Database ...
...
#> ... Number of sequences 254268
#> ... Min. sequence length 100
#> ... Max. sequence length 1000
#> ... Last_updated '2022-11-08 18:54:25'
```
