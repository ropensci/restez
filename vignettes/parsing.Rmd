...
vignette: >
  %\VignetteIndexEntry{3. Advanced parsing of a GenBank record}
...
You can try out the above functions yourself on any sequence record by downloading them through the [`rentrez` package](https://github.com/ropensci/rentrez) using `entrez_fetch(db='nucelotide', rettype='gb')`. Or why not test them out using any of the records from the rodents database?
